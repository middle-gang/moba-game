...
void HeroObj::Ability1st() {
    ...
    if(HeroIdentifier == 2) {
        ...
        Animate * action = Animate::create(animation);
        CCSprite * SkillEffect = CCSprite::create();
        SkillEffect->setPosition(Charac->getPosition());
        this->addChild(SkillEffect);
        this->SkillEffect->runAction(action);
        this->removeChild(SkillEffect);
    ...
    if (HeroIdentifier == 3) {
        if (QActivate) {
            ...
            Animate * action = Animate::create(animation);
            CCSprite * SkillEffect = CCSprite::create();
            SkillEffect->setPosition(Qtarget[Qtarget.size-1]->getPosition());
            this->addChild(SkillEffect);
            this->SkillEffect->runAction(action);
            this->removeChild(SkillEffect);
...
void HeroObj::Ability2st() {
    ...
    if (HeroIdentifier == 1) {
        if (WActivate) {
            ...
            Animate * action = Animate::create(animation);
            CCSprite * SkillEffect = CCSprite::create();
            SkillEffect->setPosition(Wtarget[Wtarget.size-1]->getPosition());
            this->addChild(SkillEffect);
            this->SkillEffect->runAction(action);
            this->removeChild(SkillEffect);
