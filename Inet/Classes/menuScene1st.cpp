...
Scene* MenuScene1st::createScene()
{
	return MenuScene1st::create();
}
...
bool MenuScene1st::init()
{
	...
	auto closeItem = MenuItemImage::create(
		"CloseNormal.png",
		"CloseSelected.png",
		CC_CALLBACK_1(MenuScene1st::menuCloseCallback, this));

	auto backItem = MenuItemImage::create("back.jpg",
		"back.jpg",
		CC_CALLBACK_1(MenuScene1st::backCallback, this));
	...
	auto homeItem = MenuItemImage::create(
		"home.jpg",
		"home.jpg",
		CC_CALLBACK_1(MenuScene1st::homeCallback, this));
...
void MenuScene1st::menuCloseCallback(Ref * pSender)
{
...
void MenuScene1st::homeCallback(cocos2d::Ref * pSender) {
	Director::getInstance()->popToRootScene();
	CocosDenshion::SimpleAudioEngine::sharedEngine()->playEffect("effectmusic1.wav", false);
}

void MenuScene1st::backCallback(cocos2d::Ref * pSender) {
